...
public class KindeditorController {
	...
	public void uploadFile(@PathVariable String privilege, @AuthenticationPrincipal UserDTO user, HttpServletRequest request, HttpServletResponse response) throws Exception {
	...
	public void fileManagerJson(@AuthenticationPrincipal UserDTO user, HttpServletRequest request, HttpServletResponse response) throws IOException {
		PrintWriter writer = response.getWriter();
