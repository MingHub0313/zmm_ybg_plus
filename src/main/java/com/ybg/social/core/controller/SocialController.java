package com.ybg.social.core.controller;
...
import com.ybg.social.core.support.SocialLoginServiceImpl;
import com.ybg.social.core.support.SocialUserInfo;
import com.ybg.social.setting.service.SocialUserService;
...
public class SocialController {
    ...
    public Json regist(UserDTO user,HttpServletRequest request,@RequestParam(name = "email",required = true) String email,@RequestParam(name = VrifyCodeUtil.PARAMETERNAME,required = true) String vrifyCode,HttpSession session) throws Exception{
        Json j = new Json();
        j.setMsg("操作成功");
        j.setSuccess(true);
    ...
    public Json bind(String username,String password,HttpServletRequest httpServletRequest,ModelMap map) throws Exception{
        Json j = new Json();
        j.setMsg("操作成功");
        j.setSuccess(true);
        // 首先检测验证码
        ...
        if (connection != null) {
            ...
            return othertype(username,password,httpServletRequest);
        }
    ...
    /** 非正规渠道绑定。 **/
    private Json othertype(String username,String password,HttpServletRequest httpServletRequest) throws AuthenticationException, Exception{
        Json j = new Json();
        Loginproxy proxy = LoginProxyController.login(httpServletRequest, username, password, null);
        if (proxy.isSuccess()) {
