package com.ybg.social.setting.controller;
...
public class ThirdPartLoginController {
	...
	public Map<String, Object> boundinfo(@AuthenticationPrincipal UserDTO user) throws Exception {
	...
	public Json delbaidu(@AuthenticationPrincipal UserDTO user, String providerid) throws Exception {
