...
import com.ybg.gen.domain.GenstyleDO;
 ...
 * @date 2018-05-31
 */
@ApiModel(value = "角色查询条件", parent = GenstyleDO.class)
public class GenstyleQuery extends GenstyleDO implements BaseQueryAble {
