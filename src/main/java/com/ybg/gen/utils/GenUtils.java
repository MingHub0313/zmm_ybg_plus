...
public class GenUtils {
     ...
     * @throws Exception
     */
    public static void generatorCode(Map<String, String> table,List<Map<String, String>> columns,ZipOutputStream zip,String styleid) throws Exception{
        // 配置信息
        ...
        // 获取模板列表
        List<GenTempDTO> templates = getTemplates(styleid);
        for (GenTempDTO template : templates) {
            // 渲染模板
