...
public class ScheduleJobLogDaoImpl extends BaseDao implements ScheduleJobLogDao {
    ...
    public ScheduleJobLogDO queryObject(Long jobId){
        ...
        List<ScheduleJobLogDO> list = getJdbcTemplate().query(sql.toString(), new BeanPropertyRowMapper<ScheduleJobLogDO>(ScheduleJobLogDO.class));
    ...
    public Page queryList(Page page,ScheduleJobLogQuery qvo) throws Exception{
        ...
        List<ScheduleJobLogDO> list = getJdbcTemplate().query(page.getPagesql(sql), new BeanPropertyRowMapper<ScheduleJobLogDO>(ScheduleJobLogDO.class));
        page.setResult(list);
