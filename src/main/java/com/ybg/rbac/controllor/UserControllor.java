...
public class UserControllor {
	...
	// @ApiImplicitParams({ @ApiImplicitParam(name = "pageNow", value = "当前页数",
	// required = true, dataType = "java.lang.Integer"), @ApiImplicitParam(name =
	// "qvo", value = "用户查询条件", required = false, dataType = "UserQvo") })
	@ResponseBody
	@RequestMapping(value = { "list.do" }, method = { RequestMethod.GET, RequestMethod.POST })
	public Page list(@ModelAttribute UserQuery qvo, @ModelAttribute Page page, @ApiIgnore ModelMap modelMap)
			throws Exception {
		qvo.setBlurred(true);
		// Page page = new Page();
		// page.setCurPage(pageNow);
		page = userService.list(page, qvo);
		List<UserDTO> list = (List<UserDTO>) page.getResult();
	...
	public ResponseEntity<Map<String, Object>> get(@RequestParam(name = "id", required = true) String id)
		...
		UserDTO bean = userService.get(id);
		// 敏感信息禁止泄露
		bean.setPassword("");
	...
	public Json update(@RequestBody UserDTO user) {
