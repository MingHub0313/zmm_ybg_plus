package com.ybg.weixin.tags.controller;
...
import com.ybg.weixin.tags.service.WeixinTagsService;
...
public class WeixinTagsController {
	...
	public Page list() {
		Page page = new Page();
		List<WeixinTagsDTO> list = weixinTagsService.list();
		page.setCurPage(1);
		page.setResult(list);
...
//		page.init();
	...
	public Json create(@RequestBody WeixinTagsDTO tags) {
		Json j = new Json();
		try {
	...
	public Json update(@RequestBody WeixinTagsDTO tags) {
		Json j = new Json();
