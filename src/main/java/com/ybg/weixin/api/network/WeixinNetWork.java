package com.ybg.weixin.api.network;
...
public interface WeixinNetWork {
	...
	/** 发送模板消息 */
	WeixinJson template_send(String token, String template_id, String touser, String url, String miniprogram,
			String appid, String pagepath, String data, String color);
	// 一次性订阅消息
